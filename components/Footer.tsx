      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm">NextGen E-commerce is your one-stop shop for all your needs. We offer a wide range of high-quality products at competitive prices.</p>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center">
          <p>&copy; 2023 NextGen E-commerce. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
